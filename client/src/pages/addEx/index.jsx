...
export const AddEx = () => {
    ...
    const AddExercise = async (e) => {
        ...
        if (exname && category && description && file) {
            ...
            await client.post("exercises/", formData, {
                headers: {
                ...
                alert("Помилка додавання спробуйте пізніше");
            });
            //} else {
            //    alert("Err");
            // }
        ...
        <div>
            ...
            <div>
                <div className="h-screen flex bg-white">
                    <form onSubmit={AddExercise} className="m-auto w-auto border-1 border-black rounded-md bg-lime-50 shadow-md shadow-gray-700 flex flex-col">
                        ...
                        <div className="mt-5 mx-3">
                            ...
                            <div className="flex mt-5">
                                <select onChange={handleChange} value={inputValue.category} name="category" className="w-full outline-none text-xl placeholder-slate-600 rounded-sm mx-2 px-3 py-2 border-2 border-gray-400">
                            ...
                            <button type="submit" className="w-full py-2 mt-5 shadow-sm shadow-black bg-[#FF7F50] focus:bg-[#FF7F50] hover:bg-[#FFA07A]">Додати</button>
                        </div>
