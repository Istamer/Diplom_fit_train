...
const ProfilePurchase = () => {
    ...
    const handleBuyClick = async () => {
        ...
        if (token) {
            dispatch(loadOn());
            await client.post("auth/buypremium", {}, {
            ...
            <div className="bg-exfon bg-fixed">
                <div className="w-full py-16 px-4">
                    ...
                    <div className="flex justify-center max-w-[1240px] mx-auto pt-9">
                        ...
                        {
                            user ? <button onClick={handleBuyClick} className="bg-[#FF7F50] w-[700px] rounded-md font-bold text-black my-6 mx-auto md:mx-0 py-3">Отримати профіль</button> : null
                        }
                    </div>
                </div>
            </div>
